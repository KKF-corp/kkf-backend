...
@Schema(description = "Filtr do wyszukiwania przychodów")
public class RevenueCriteria {
    ...
    @Schema(description = "Filtrowanie według daty sprzedaży")
    private LocalDate filterBySaleDate;
    ...
    public LocalDate getFilterBySaleDate() {
        return filterBySaleDate;
    }

    public void setFilterBySaleDate(LocalDate filterBySaleDate) {
        this.filterBySaleDate = filterBySaleDate;
    }
