...
public interface TransactionServiceApiService {
    ...
    TransactionServiceDto createTransactionService(@Parameter(description = "Obiekt usługi")
                                                   @Valid TransactionServiceDto transactionService);
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    TransactionServiceSearchResponse findByCriteria(@Parameter(description = "Zapytanie wyszukiwania usługi")
                                                    @Valid TransactionServiceSearchRequest request);
