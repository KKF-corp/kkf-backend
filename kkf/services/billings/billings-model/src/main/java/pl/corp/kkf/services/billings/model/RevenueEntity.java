...
public class RevenueEntity extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(name, that.name) && Objects.equals(description, that.description) && Objects.equals(deleted, that.deleted) && Objects.equals(saleDate, that.saleDate) && Objects.equals(totalNetPrice, that.totalNetPrice) && Objects.equals(totalGrossPrice, that.totalGrossPrice) && Objects.equals(transactionType, that.transactionType) && Objects.equals(contractor, that.contractor);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, deleted, saleDate, totalNetPrice, totalGrossPrice, transactionType, contractor);
    }
}