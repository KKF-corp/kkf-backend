...
public class TransactionServiceValidator implements BaseValidator {
    ...
    public void validateForCreation(@NotNull TransactionServiceDto dto) {
        check(nonNull(dto.getId()), "Identyfikator już istnieje podczas tworzenia!");
        validateForCreateOrUpdate(dto);
    }

    public void validateForUpdate(@NotNull TransactionServiceDto dto) {
        check(isNull(dto.getId()), "Identyfikator nie istnieje podczas modyfikacji!");
        validateForCreateOrUpdate(dto);
    }

    private void validateForCreateOrUpdate(@NotNull TransactionServiceDto dto) {
