...
@Entity
@Table(name = "TRANSACTION_POSITIONS", schema = "KKF")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
public abstract class TransactionPositionEntity extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SequenceTransactionPositionEntity")
    @SequenceGenerator(name = "SequenceTransactionPositionEntity", schema = "KKF", sequenceName = "SEQ_TRANSACTION_POSITIONS")
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        TransactionPositionEntity that = (TransactionPositionEntity) o;
